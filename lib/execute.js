...
function setDeploymentInactive(
  client,
...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      yield (0,
      p_series_1.default)(deploymentIds.map((deploymentId) => () => setDeploymentInactive(client, Object.assign(Object.assign({}, context.repo), { deploymentId }))));
      if (deleteDeployment) {
        core.info(deleteDeploymentMessage);
        yield (0, p_series_1.default)(
          deploymentIds.map(
            (deploymentId) => () =>
